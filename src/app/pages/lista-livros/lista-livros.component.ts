...
export class ListaLivrosComponent implements AfterViewInit {
  ...
  /*
    ViewChild é um decorator do angular ultilizado para conseguir obter a referência de um elemento do DOM. 
    Essa referência será do tipo ElementRef nesse caso.
  */
  @ViewChild('campoBuscarElement') campoBuscarElement!: ElementRef;

  constructor(private service: LivroService) { }

  ngAfterViewInit(): void {
    this.campoBuscarElement.nativeElement.focus();
  }
